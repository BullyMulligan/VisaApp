...
namespace VisaApp
{
    public class Sel
    {
        ...
        public void PersonalOne()
        {
            ...
            SendKeysOriginal(Personal1.fieldFullName,$"{_survey.full_name.surnname} {_survey.full_name.name} {_survey.full_name.fathername}");
        ...
        public void AddPrevious()
        {
            ...
            {
                AddDate(_survey.date_arrival,Previous.selectDateArrivedDay,Previous.selectDateArrivedMonth,Previous.fieldDateArrivedYear);
                ...
                if (CheckBox(_survey.have_driver_doc,Previous.checkHaveDriverLicenseYes,Previous.checkHaveDriverLicenseNo))
                {
            ...
            {
                AddDate(_survey.date_issue_visa,Previous.selectDateIssueDay,Previous.selectDateIssueMonth,Previous.fieldDateIssueYear);
        ...
        {
            Thread.Sleep(500);
            Driver.Navigate().GoToUrl("https://ceac.state.gov/GenNIV/General/complete/complete_contact.aspx?node=AddressPhone");
            ...
            if (CheckBox((_survey.numbers_of_fives_years != null), Address.checkHaveAnotherNumbersYes, Address.checkHaveAnotherNumbersNo))
            {
            ...
            if (CheckBox((_survey.email_adresses!=null),Address.checkHaveAnotherEmailYes,Address.checkHaveAnotherEmailNo))
            {
            ...
            {
                Select(By.Id($"ctl00_SiteContentPlaceHolder_FormView1_dtlSocial_ctl0{i}_ddlSocialMedia"), _survey.public_links[i].linl_soc_web);
                SendKeysOriginal(By.Id($"ctl00_SiteContentPlaceHolder_FormView1_dtlSocial_ctl0{i}_tbxSocialMediaIdent"), _survey.public_links[i].link_to_account);
            }
        ...
        {
            Thread.Sleep(500);
            Driver.Navigate().GoToUrl("https://ceac.state.gov/GenNIV/General/complete/Passport_Visa_Info.aspx?node=PptVisa");
        ...
        {
            Thread.Sleep(500);
            Driver.Navigate().GoToUrl("https://ceac.state.gov/GenNIV/General/complete/complete_uscontact.aspx?node=USContact");
            SendKeys(USContactInformation.fieldContactPersonSurname,_survey.inviter.surname);
            DoesNotApply(_survey.inviter.name,USContactInformation.fieldContactPersonName,USContactInformation.checkDontRnowName);
            DoesNotApply(_survey.inviter.company_name,USContactInformation.fieldOrganizationName,USContactInformation.checkDontKnowOrganization);
            Select(USContactInformation.selectRelationship,_survey.inviter.relationship);
            FillLinesAddress(_survey.inviter.address.street,USContactInformation.fieldStreet1,USContactInformation.fieldStreet2);
        ...
        {
            Thread.Sleep(500);
            Driver.Navigate().GoToUrl("https://ceac.state.gov/GenNIV/General/complete/complete_family1.aspx?node=Relatives");
            ...
            {
                AddDate(_survey.father.birth_date,FamilyInfo.selectFatherDay,FamilyInfo.selectFatherMonth,FamilyInfo.fieldFatherYear);
            }
            else
            {
            ...
            {
                AddDate(_survey.mother.birth_date,FamilyInfo.selectMotherDay,FamilyInfo.selectMotherMonth,FamilyInfo.fieldMotherYear);
            }
            else
            {
        ...
        {
            Thread.Sleep(500);
            Driver.Navigate().GoToUrl("https://ceac.state.gov/GenNIV/General/complete/complete_family2.aspx?node=Spouse");
        ...
        public void AdditionalWork()
        {
            ...
            AddDate(_survey.job[0].start_date,Additional.selectStartDay,Additional.selectStartMonth,Additional.fieldStartYear);
        ...
        public void AdditionalPrevious()
        {
            ...
            if (_survey.job.Count>1)
            {
                ...
                for (int i = 0; i < _survey.job.Count; i++)
                {
                    ...
                    FillLinesAddress(_survey.job[i].address.street,StringBy(PreviousWork.fieldStreet1,i),StringBy(PreviousWork.fieldStreet2,i));
                    SendKeys(StringBy(PreviousWork.fieldCity,i),_survey.job[i].address.city);
                    DoesNotApply(_survey.job[i].address.region,StringBy(PreviousWork.fieldState,i),StringBy(PreviousWork.checkStateNotApply,i));
                    DoesNotApply(_survey.job[i].address.index,StringBy(PreviousWork.fieldZip,i),StringBy(PreviousWork.checkZipNotApply,i));
                    ...
                    DoesNotApply(_survey.job[i].supervizor_surname,StringBy(PreviousWork.fieldSupervizorSurname,i),StringBy(PreviousWork.checkSurnameSupervizorSurnameDontKnow,i));
                    DoesNotApply(_survey.job[i].supervizor_name,StringBy(PreviousWork.fieldSupervizorName,i),StringBy(PreviousWork.checkSurnameSupervizorNameDontKnow,i));
